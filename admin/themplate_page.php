...
class poll_manager_design {
	...
	private function save_poll() {
		...
		if ($save_or_no) {
			?><div class="updated">
				<p><strong>Item Saved</strong></p>
			</div><?php
				} else {
					?><div id="message" class="error">
				<p>Error please reinstall plugin</p>
			</div> <?php
				}
			}
			...
			private function update_poll($id) {
				...
				$wpdb->update(
					...
					array(
						'name' => sanitize_text_field($name),
						'option_value' => sanitize_text_field($parametrs),
					),
					array(
						'id' => $id
					),
			...
			private function remove_theme($id) {
				...
				?><div id="message" class="error">
				<p>You cannot remove default theme</p>
			</div> <?php
				}
			}
			...
			/*############  Function for themes table list  ################*/
		...
		<script>
			var my_table_list = <?php echo $this->generete_jsone_list(); ?>
		</script>
		<div class="wrap">
			<div class="wpdevart_plugins_header div-for-clear">
				...
				<a target="blank" href="<?php echo esc_url(wpdevart_polls_support_url); ?>" class="wpdevart_support">Have any Questions? Get a quick support!</a>
			</div>
				...
				<table class="wp-list-table widefat fixed pages" style="width:95%">
					...
					<tbody>
						<tr ng-repeat="rows in names | filter:filtering_table" class="description_row">
							...
							<td><a href="admin.php?page=Polls-design&task=set_default_theme&id={{rows.id}}"><img src="<?php echo esc_url($this->plugin_url . 'admin/images/default'); ?>{{rows.default}}.png"></a></td>
	...
	<?php
			...
			/*############  Function for generating the JSone list  ################*/
			...
			private function add_edit_theme($id = 0) {
				...
				$poll_parametrs = isset($theme->option_value)?json_decode($theme->option_value, true):array();
				$poll_name = isset($id)?$theme->name:'';
	?>
		...
		<style id="style_poll_background_opacity_input">
			.main_div_of_the_poll_answer {
				background-color: <?php echo $this->hex2rgba(esc_html($poll_parametrs['poll_background_color']), esc_html($poll_parametrs['poll_background_opacity'])) ?>;
			}
		</style>
		<style id="style_poll_background_opacity_hower_input">
			.main_div_of_the_poll_answer:hover {
				background-color: <?php echo $this->hex2rgba(esc_html($poll_parametrs['poll_background_color_hower']), esc_html($poll_parametrs['poll_background_opacity_hower'])) ?>;
			}
		</style>
		<style id="style_poll_answer_width_input">
			.main_div_of_the_poll_answer {
				width: <?php echo esc_html($poll_parametrs['poll_answer_width']) ?>%;
			}
		</style>
		<style id="style_poll_answer_width_hower_input">
			.main_div_of_the_poll_answer:hover {
				width: <?php echo esc_html($poll_parametrs['poll_answer_width_hower']) ?>%;
			}
		</style>
		<style id="style_poll_answer_height_input">
			.main_div_of_the_poll_answer {
				height: <?php echo esc_html($poll_parametrs['poll_answer_height']) ?>px;
			}
		</style>
		<style id="style_poll_answer_height_hower_input">
			.main_div_of_the_poll_answer:hover {
				height: <?php echo esc_html($poll_parametrs['poll_answer_height_hower']) ?>px;
			}
		</style>
		<style id="style_poll_answer_inner_distance_input">
			.main_div_of_the_poll_answer {
				margin-bottom: <?php echo esc_html($poll_parametrs['poll_answer_inner_distance']) ?>px;
			}
		</style>
		<style id="style_poll_answer_fontsize_input">
			.poll_answer_title {
				font-size: <?php echo esc_html($poll_parametrs['poll_answer_fontsize']) ?>px;
			}
		</style>
		<style id="style_poll_answer_fontsize_hower_input">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				font-size: <?php echo esc_html($poll_parametrs['poll_answer_fontsize_hower']) ?>px;
			}
		</style>
		<style id="style_poll_answer_of_the_top_input">
			.main_div_of_the_poll_answer .poll_answer_title {
				top: <?php echo esc_html($poll_parametrs['poll_answer_of_the_top']) ?>px;
			}
		</style>
		<style id="style_poll_answer_of_the_top_hower_input">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				top: <?php echo esc_html($poll_parametrs['poll_answer_of_the_top_hower']) ?>px;
			}
		</style>
		<style id="style_poll_answer_of_the_left_input">
			.main_div_of_the_poll_answer .poll_answer_title {
				left: <?php echo esc_html($poll_parametrs['poll_answer_of_the_left']) ?>px;
			}
		</style>
		<style id="style_poll_answer_of_the_left_hower_input">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				left: <?php echo esc_html($poll_parametrs['poll_answer_of_the_left_hower']) ?>;
			}
		</style>
		<style id="style_color_responding_of_the_answer_input">
			.main_div_of_the_poll_answer .pracents_of_the_poll {
				background-color: <?php echo esc_html($poll_parametrs['color_responding_of_the_answer']) ?>;
			}
		</style>
		<style id="style_color_responding_of_the_answer_hower_input">
			.main_div_of_the_poll_answer:hover .pracents_of_the_poll {
				background-color: <?php echo esc_html($poll_parametrs['color_responding_of_the_answer_hower']) ?>;
			}
		</style>
		<style id="style_color_of_the_answer_text_input">
			.main_div_of_the_poll_answer .poll_answer_title {
				color: <?php echo esc_html($poll_parametrs['color_of_the_answer_text']) ?>;
			}
		</style>
		<style id="style_color_of_the_answer_text_hower_input">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				color: <?php echo esc_html($poll_parametrs['color_of_the_answer_text_hower']) ?>;
			}
		</style>
		<style id="style_font_family_of_answer_text">
			.main_div_of_the_poll_answer .poll_answer_title {
				font-family: <?php echo esc_html($poll_parametrs['font_family_of_answer_text']) ?>;
			}
		</style>
		<style id="style_font_family_of_answer_text_hower">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				font-family: <?php echo esc_html($poll_parametrs['font_family_of_answer_text_hower']) ?>;
			}
		</style>
		<style id="style_font_style_of_answer_text_bold">
			.main_div_of_the_poll_answer .poll_answer_title {
				font-weight: <?php echo esc_html($poll_parametrs['font_style_of_answer_text_bold'] ? 'bold' : 'normal') ?>;
			}
		</style>
		<style id="style_font_style_of_answer_text_italick">
			.main_div_of_the_poll_answer .poll_answer_title {
				font-style: <?php echo esc_html($poll_parametrs['font_style_of_answer_text_italick'] ? 'italic' : 'normal') ?>;
			}
		</style>
		<style id="style_font_style_of_answer_text_bold_hower">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				font-weight: <?php echo esc_html($poll_parametrs['font_style_of_answer_text_bold_hower'] ? 'bold' : 'normal') ?>;
			}
		</style>
		<style id="style_font_style_of_answer_text_italick_hower">
			.main_div_of_the_poll_answer:hover .poll_answer_title {
				font-style: <?php echo esc_html($poll_parametrs['font_style_of_answer_text_italick_hower'] ? 'italic' : 'normal') ?>;
			}
		</style>
		<style id="style_poll_answer_border_width_input">
			.main_div_of_the_poll_answer {
				border-width: <?php echo esc_html($poll_parametrs['poll_answer_border_width']) ?>px;
			}
		</style>
		<style id="style_poll_answer_border_width_hower_input">
			.main_div_of_the_poll_answer:hover {
				border-width: <?php echo esc_html($poll_parametrs['poll_answer_border_width_hower']) ?>px;
			}
		</style>
		<style id="style_poll_answer_border_radius_input">
			.main_div_of_the_poll_answer {
				border-radius: <?php echo esc_html($poll_parametrs['poll_answer_border_radius']) ?>px;
			}
		</style>
		<style id="style_poll_answer_border_radius_hower_input">
			.main_div_of_the_poll_answer:hover {
				border-radius: <?php echo esc_html($poll_parametrs['poll_answer_border_radius_hower']) ?>px;
			}
		</style>
		<style id="style_poll_answer_border_type">
			.main_div_of_the_poll_answer {
				border-style: <?php echo esc_html($poll_parametrs['poll_answer_border_type']) ?>;
			}
		</style>
		<style id="style_poll_answer_border_type_hower">
			.main_div_of_the_poll_answer:hover {
				border-style: <?php echo esc_html($poll_parametrs['poll_answer_border_type_hower']) ?>;
			}
		</style>
		<style id="style_color_of_the_border_input">
			.main_div_of_the_poll_answer {
				border-color: <?php echo esc_html($poll_parametrs['color_of_the_border']) ?>;
			}
		</style>
		<style id="style_color_of_the_border_input_hower">
			.main_div_of_the_poll_answer:hover {
				border-color: <?php echo esc_html($poll_parametrs['color_of_the_border_hower']) ?>;
			}
		</style>
		<style id="style_poll_show_count_option">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				display: <?php echo $poll_parametrs['poll_show_count_option'] ? 'inline-block' : 'none' ?>
			}
		</style>
		<style id="style_poll_show_count_option_hower">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				display: <?php echo $poll_parametrs['poll_show_count_option_hower'] ? 'inline-block' : 'none' ?>
			}
		</style>
		<style id="style_poll_count_fontsize_input">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				font-size: <?php echo esc_html($poll_parametrs['poll_count_fontsize']) ?>px;
			}
		</style>
		<style id="style_poll_count_fontsize_hower_input">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				font-size: <?php echo esc_html($poll_parametrs['poll_count_fontsize_hower']) ?>px;
			}
		</style>
		<style id="style_poll_count_of_the_left_input">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				right: <?php echo esc_html($poll_parametrs['poll_count_of_the_left']) ?>px;
			}
		</style>
		<style id="style_poll_count_of_the_left_hower_input">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				right: <?php echo esc_html($poll_parametrs['poll_count_of_the_left_hower']) ?>px;
			}
		</style>
		<style id="style_poll_count_of_the_top_input">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				top: <?php echo esc_html($poll_parametrs['poll_count_of_the_top']) ?>px;
			}
		</style>
		<style id="style_poll_count_of_the_top_hower_input">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				top: <?php echo esc_html($poll_parametrs['poll_count_of_the_top_hower']) ?>px;
			}
		</style>
		<style id="style_color_of_the_count_input">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				color: <?php echo esc_html($poll_parametrs['color_of_the_count_input']) ?>;
			}
		</style>
		<style id="style_color_of_the_count_hower_input">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				color: <?php echo esc_html($poll_parametrs['color_of_the_count_hower']) ?>;
			}
		</style>
		<style id="style_font_family_of_count_text">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				font-family: <?php echo esc_html($poll_parametrs['font_family_of_count_text']) ?>;
			}
		</style>
		<style id="style_font_family_of_count_text_hower">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				font-family: <?php echo esc_html($poll_parametrs['font_family_of_count_text_hower']) ?>;
			}
		</style>
		<style id="style_font_style_of_count_text_bold">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				font-weight: <?php echo esc_html($poll_parametrs['font_style_of_count_text_bold'] ? 'bold' : 'normal') ?>;
			}
		</style>
		<style id="style_font_style_of_count_text_italick">
			.main_div_of_the_poll_answer .poll_span_voted_count {
				font-style: <?php echo esc_html($poll_parametrs['font_style_of_count_text_italick'] ? 'italic' : 'normal') ?>;
			}
		</style>
		<style id="style_font_style_of_count_text_bold_hower">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				font-weight: <?php echo esc_html($poll_parametrs['font_style_of_count_text_bold_hower'] ? 'bold' : 'normal') ?>;
			}
		</style>
		<style id="style_font_style_of_count_text_italick_hower">
			.main_div_of_the_poll_answer:hover .poll_span_voted_count {
				font-style: <?php echo esc_html($poll_parametrs['font_style_of_count_text_italick_hower'] ? 'italic' : 'normal') ?>;
			}
		</style>
		<style>
			.main_div_of_the_poll_answer {
		...
		<script>
			...
			jQuery(function() {
				jQuery("#poll_background_opacity").slider({
					range: "min",
					value: <?php echo $poll_parametrs['poll_background_opacity'] ? esc_html($poll_parametrs['poll_background_opacity']) : '0'; ?>,
					min: 0,
					max: 100,
			...
			jQuery(function() {
				jQuery("#poll_background_opacity_hower").slider({
					range: "min",
					value: <?php echo $poll_parametrs['poll_background_opacity_hower'] ? esc_html($poll_parametrs['poll_background_opacity_hower']) : '0'; ?>,
					min: 1,
					max: 100,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_width").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_width']) ?>,
					min: 0,
					max: 100,
					slide: function(event, ui) {
			...
			jQuery(function() {
				jQuery("#poll_answer_width_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_width_hower']) ?>,
					min: 1,
					max: 100,
					slide: function(event, ui) {
						jQuery("#poll_answer_width_hower_input").val(ui.value);
			...
			jQuery(function() {
				jQuery("#poll_answer_height").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_height']) ?>,
					min: 10,
					max: 200,
					slide: function(event, ui) {
			...
			jQuery(function() {
				jQuery("#poll_answer_height_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_height_hower']) ?>,
					min: 10,
					max: 200,
					slide: function(event, ui) {
						jQuery("#poll_answer_height_hower_input").val(ui.value);
			...
			jQuery(function() {
				jQuery("#poll_answer_inner_distance").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_inner_distance']) ?>,
					min: 0,
					max: 100,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_fontsize").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_fontsize']) ?>,
					min: 5,
					max: 80,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_fontsize_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_fontsize_hower']) ?>,
					min: 5,
					max: 80,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_of_the_top").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_of_the_top']) ?>,
					min: 0,
					max: 80,
					slide: function(event, ui) {
			...
			jQuery(function() {
				jQuery("#poll_answer_of_the_top_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_of_the_top_hower']) ?>,
					min: 0,
					max: 80,
					slide: function(event, ui) {
						jQuery("#poll_answer_of_the_top_hower_input").val(ui.value);
			...
			jQuery(function() {
				jQuery("#poll_answer_of_the_left").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_of_the_left']) ?>,
					min: 0,
					max: 80,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_of_the_left_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_of_the_left_hower']) ?>,
					min: 0,
					max: 80,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_border_width").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_border_width']) ?>,
					min: 0,
					max: 30,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_border_width_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_border_width_hower']) ?>,
					min: 0,
					max: 30,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_border_radius").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_border_radius']) ?>,
					min: 0,
					max: 100,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_answer_border_radius_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_answer_border_radius_hower']) ?>,
					min: 0,
					max: 100,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_count_fontsize").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_count_fontsize']) ?>,
					min: 0,
					max: 50,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_count_fontsize_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_count_fontsize_hower']) ?>,
					min: 0,
					max: 50,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_count_of_the_left").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_count_of_the_left']) ?>,
					min: 0,
					max: 150,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_count_of_the_left_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_count_of_the_left_hower']) ?>,
					min: 0,
					max: 150,
					slide: function(event, ui) {
						return false;
			...
			jQuery(function() {
				jQuery("#poll_count_of_the_top").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_count_of_the_top']) ?>,
					min: 0,
					max: 150,
					slide: function(event, ui) {
			...
			jQuery(function() {
				jQuery("#poll_count_of_the_top_hower").slider({
					range: "min",
					value: <?php echo esc_html($poll_parametrs['poll_count_of_the_top_hower']) ?>,
					min: 0,
					max: 150,
					slide: function(event, ui) {
						jQuery("#poll_count_of_the_top_hower_input").val(ui.value);
		...
		<form action="admin.php?page=Polls-design<?php if ($id) {echo '&id=' . intval($id);}; ?>" method="post" name="adminForm" class="top_description_table" id="adminForm">
			<div class="conteiner">
				<div class="header">
					<span>
						<h2 class="poll_theme_title">Add Theme</h2>
					</span>
				...
				<div class="option_panel">
					...
					<div class="all_options_panel">
						<input type="text" class="poll_name" name="poll_name" placeholder="Enter name here" value="<?php echo esc_html($poll_name); ?>">
						<table class="all_options_panel_table wp-list-table widefat fixed posts">
							...
							<tbody>
								<tr>
									<td>
										The Poll Width <span title="Set the Poll width. Select 100% to set full with option for the Poll. Then set the Poll width when hovering." class="desription_class">?</span>
									</td>
									<td>
									...
									<td rowspan="10000" style="background-color:#FFFFFF">
										...
										<a target="_blank" class="update_pro" href="https://wpdevart.com/wordpress-polls-plugin/"><span style="color: #7052fb; font-weight: bold; font-size: 21px;">Upgrade to Premium Version</span></a>
									</td>
								</tr>

								<tr>
									<td>
										The Poll height <span title="Set the Poll height. Then set the Poll height when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Poll position <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the Poll position" class="desription_class">?</span>
									</td>
									<td>
										<?php
										$this->select_align_with_label('poll_align', isset($poll_parametrs['poll_align']) ? esc_html($poll_parametrs['poll_align']) : "left"); ?>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Poll background color <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll background color. Then set the Poll background color when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Poll background opacity <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll background opacity. Then set the Poll background opacity when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The distance between answers <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the distance between Poll answers." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Answer font size <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the font size of the Poll answer. Then set the Poll answer font size when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										The Answer distance from the top <span title="Set the Poll answer distance from the top. Then set the Poll answer distance from the top when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Answer distance from the left <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll answer distance from the left. Then set the Poll answer distance from the left when hovering. " class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										Background color corresponding counts <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll background color corresponding counts. Then set the Poll background color corresponding counts when hovering." class="desription_class">?</span>
									</td>
									<td>
										<div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
								...
								<tr>
									<td>
										The Answer color <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the color of the Poll answers. Then set the color of the Poll answers when hovering." class="desription_class">?</span>
									</td>
									<td>
										<div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
								...
								<tr>
									<td>
										The Answer font family <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the font family of the Poll answers. Then select the font family of the Poll answers when hovering." class="desription_class">?</span>
									</td>
									<td>
										<?php
										$this->select_font_with_label('font_family_of_answer_text', esc_html($poll_parametrs['font_family_of_answer_text'])); ?>
									</td>
									<td>
										<?php $this->select_font_with_label('font_family_of_answer_text_hower', esc_html($poll_parametrs['font_family_of_answer_text_hower']), 'font_family_of_answer_text'); ?>
								...
								<tr>
									<td>
										The Answer font style <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll answer font style. Then set the Poll answer font style when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Poll border width <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll border width. Then set the Poll border width when hovering" class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Poll border Radius <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll border Radius. Then set the Poll border Radius when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										The Poll border type <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the Poll border type. Then select the Poll border type when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										The Poll border color <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the Poll border color. Then set the Poll border color when hovering." class="desription_class">?</span>
									</td>
									<td>
										<div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
								...
								<tr>
									<td>
										Show the count option <span class="pro_subtitle_span">Pro feature!</span> <span title="If you want to display the count options then choose yes. Then set the same option for the hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Count font size <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the count font size. Then set the count font size when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr class="pro_paramets">
									<td>
										The Count distance from the left <span class="pro_subtitle_span">Pro feature!</span> <span title="Set the count distance from the left. Then set the count distance from the left when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										The Count distance from the top <span title="Set the count distance from the top. Then set the count distance from the top when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										The Count text color <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the Poll count text color. Then select the Poll count text color when hovering." class="desription_class">?</span>
									</td>
									<td>
										<div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
								...
								<tr>
									<td>
										The Count text font family <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the Poll count text font family. Then select the Poll count text font family when hovering." class="desription_class">?</span>
									</td>
									<td>
								...
								<tr>
									<td>
										The Count text font style <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the Poll count text font style. Then select the Poll count text font style when hovering." class="desription_class">?</span>
									</td>
									<td>
	...
	<?php
			...
			/*############  Function for the font option  ################*/

			private function select_font_with_label($select_name, $main_value = '', $bind = '') {
	?>

		<select class="poll_select" name="<?php echo 'parametrs[' . esc_html($select_name) . ']'; ?>" id="<?php echo esc_html($select_name) ?>">
			<?php

				foreach ($this->fonts_options() as $key => $value) {
			?>
				<option <?php selected($key, $main_value) ?> value="<?php echo esc_html($key) ?>"><?php echo esc_html($value) ?></option>
			<?php
				}
			?>
		</select>
	...
	?>
		<select class="poll_select" name="<?php echo 'parametrs[' . esc_attr($select_name) . ']'; ?>" id="<?php echo esc_attr($select_name) ?>">
			<?php
